...
export const clientValidationSchema = v.object({
    ...
    phone: v.pipe(v.string(CLIENT_VALIDATION_MESSAGES.PHONE_REQUIRED), v.transform((value) => value.trim()), v.nonEmpty(CLIENT_VALIDATION_MESSAGES.PHONE_REQUIRED), v.regex(/^\d{10}$/, CLIENT_VALIDATION_MESSAGES.PHONE_INVALID), v.custom((value) => value.length === 10, CLIENT_VALIDATION_MESSAGES.PHONE_TOO_SHORT)),
