...
export const uploadInvoiceItemValidationSchema = v.object({
  name: v.optional(
...
export const UploadValidationSchema = v.array(uploadInvoiceItemValidationSchema);
export type UploadInvoiceValidationInput = v.InferInput<typeof UploadValidationSchema>