...
const generateFakeInvoice = (serviceId: number, clientId: number, monthOffset: number) => {
...
const generateInvoicesForService = (serviceId: number, clientId: number, numInvoices: number = 10) => {
